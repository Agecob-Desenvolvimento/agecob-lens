...
# /dashboard/ (dados) + /admin/ (DBA) + /regressao/ (fit de sklearn, CPU por
# chamada). Mesmo bucket por (client_ip, api_key); /health/ e demais ficam fora
# p/ não atrapalhar monitoramento e navegação normal do SPA.
_RATE_LIMITED_PREFIXES = ("/dashboard/", "/admin/", "/regressao/")
