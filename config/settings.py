...
STATUS_EXCECAO: Tuple[int, ...] = (11,)
STATUS_UNIVERSO_ACORDOS: Tuple[int, ...] = STATUS_APROVADOS + STATUS_EXCECAO  # (1, 3, 11, 12)

CPC_COMPLEMENTO_IDS: Tuple[int, ...] = (252, 130, 110, 111, 253, 144, 151, 216, 140, 108, 90)
